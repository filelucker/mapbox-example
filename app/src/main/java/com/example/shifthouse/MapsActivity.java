            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(new MapboxMap.OnMapClickListener() {
                    ...
                    public boolean onMapClick(@NonNull LatLng point) {
                        ...
                        Log.d("lat ", String.valueOf(point.getLatitude()));
                        Log.d("lon ", String.valueOf(point.getLongitude()));
...
//            Toast.makeText(MapsActivity.this, "NO routes found make sure to set right user and access token", Toast.LENGTH_LONG).show();
//            return;
//        } else if (response.body().routes().size() < 1) {
//            Toast.makeText(MapsActivity.this, "NO routes found", Toast.LENGTH_LONG).show();
//        }
//
//
    ...
    private void enableLocationComponent(@NonNull Style loadedMapStyle) {
        ...
        if (PermissionsManager.areLocationPermissionsGranted(MapsActivity.this)) {
            ...
            locationComponent.activateLocationComponent(
                    LocationComponentActivationOptions.builder(MapsActivity.this, loadedMapStyle).build());
